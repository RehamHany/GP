...
public class UserCPublicController {
    ...
    @PostMapping("/save")
    public UCPublicResponse addChallenge(@RequestBody UserChallengePublic userChallengePublic) {
         userChallengePublic.setIcon("icon");
        return ucPublicService.save(userChallengePublic);
    }
    ...
    @PutMapping("/update")
    public UCPublicResponse updateChallenge(@RequestBody UserChallengePublic userChallengePublic){
        return ucPublicService.update(userChallengePublic);
    }
