...
public class UserCPrivateController {
    ...
    @PostMapping("/save")
    public UCPrivateResponse addChallenge(@RequestBody UserChallengePrivate userChallengePrivate) {
         userChallengePrivate.setIcon("icon");
        return ucPrivateService.save(userChallengePrivate);
    }
